...
return(
    <div className="mob_popup">
        ...
        <div className="mob_color_input">
            <span>Group Color</span>
            <div className="mob_color_input_color">
                <div className={`mob_color_input_color_1 ${
                    bgColor === "rgb(179, 139, 250)" ? `highlight` : null
                }`}
                onClick={handleColor}
                ></div>
                <div className={`mob_color_input_color_2 ${
                    bgColor === "rgb(255, 121, 242)" ? `highlight` : null
                }`}
                onClick={handleColor}
                ></div>
                <div className={`mob_color_input_color_3 ${
                    bgColor === "rgb(67, 230, 252)" ? `highlight` : null
                }`}
                onClick={handleColor}
                ></div>
                <div className={`mob_color_input_color_4 ${
                    bgColor === "rgb(241, 149, 118)" ? `highlight` : null
                }`}
                onClick={handleColor}
                ></div>
                <div className={`mob_color_input_color_5 ${
                    bgColor === "rgb(0, 71, 255)" ? `highlight` : null
                }`}
                onClick={handleColor}
                ></div>
                <div className={`mob_color_input_color_6 ${
